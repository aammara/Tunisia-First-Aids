...
public class Fracture extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fracture_frm);
        ...
        Button btn1 = (Button) findViewById(R.id.button1);
 		...
 		btn1.setOnClickListener(new View.OnClickListener() {
 			...
 			public void onClick(View view) {
 				if (checkConnectivity.checkNow(Fracture.this)){ 
 					...
 					videoClient.setData(Uri.parse("http://www.youtube.com/watch?v=naFZ7dYznBQ&list=PL9AB7E1F4DEBCA00A&index=10&feature=player_embedded"));//you can try here your own video url
 			...
 			facebookicon.setOnClickListener(new OnClickListener() {
 				...
 				public void onClick(View v) {
 					...
 					Intent e = new Intent(Fracture.this, TestConnect.class);
 					 e.putExtra(android.content.Intent.EXTRA_TEXT,"http://www.youtube.com/watch?v=naFZ7dYznBQ&list=PL9AB7E1F4DEBCA00A&index=10&feature=player_embedded");
