...
public class Traumatisme extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.traumatisme_frm);
        ...
        Button btn1 = (Button) findViewById(R.id.button1);
 		...
 		btn1.setOnClickListener(new View.OnClickListener() {
 			...
 			public void onClick(View view) {
 				if (checkConnectivity.checkNow(Traumatisme.this)){ 
 					...
 					videoClient.setData(Uri.parse("http://www.youtube.com/watch?v=47laQD6GCR4&list=PL9AB7E1F4DEBCA00A&index=12&feature=player_embedded"));//you can try here your own video url
 			...
 			facebookicon.setOnClickListener(new OnClickListener() {
 				...
 				public void onClick(View v) {
 					...
 					Intent e = new Intent(Traumatisme.this, TestConnect.class);
 					 e.putExtra(android.content.Intent.EXTRA_TEXT,"http://www.youtube.com/watch?v=47laQD6GCR4&list=PL9AB7E1F4DEBCA00A&index=12&feature=player_embedded");
