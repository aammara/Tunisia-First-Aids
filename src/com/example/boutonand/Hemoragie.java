...
public class Hemoragie extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hemoragie_frm);
        ...
        Button btn1 = (Button) findViewById(R.id.button1);
 		...
 		btn1.setOnClickListener(new View.OnClickListener() {
 			...
 			public void onClick(View view) {
 				if (checkConnectivity.checkNow(Hemoragie.this)){ 
 					...
 					videoClient.setData(Uri.parse("http://www.youtube.com/watch?v=DyW2UCDvVSU"));//you can try here your own video url
 			...
 			facebookicon.setOnClickListener(new OnClickListener() {
 				...
 				public void onClick(View v) {
 					...
 					Intent e = new Intent(Hemoragie.this, TestConnect.class);
 					 e.putExtra(android.content.Intent.EXTRA_TEXT,"http://www.youtube.com/watch?v=DyW2UCDvVSU");
