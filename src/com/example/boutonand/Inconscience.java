...
public class Inconscience extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inconscience_frm);
        ...
        Button btn1 = (Button) findViewById(R.id.button1);
 			...
 			btn1.setOnClickListener(new View.OnClickListener() {
 				...
 				public void onClick(View view) {
 					if (checkConnectivity.checkNow(Inconscience.this)){ 

 						Intent videoClient = new Intent(Intent.ACTION_VIEW);
 						videoClient.setData(Uri.parse("http://www.youtube.com/watch?v=wWIuZQaRopI&list=PL9AB7E1F4DEBCA00A&index=14&feature=player_embedded"));//you can try here your own video url
 				...
 				facebookicon.setOnClickListener(new OnClickListener() {
 					...
 					public void onClick(View v) {
 						...
 						Intent e = new Intent(Inconscience.this, TestConnect.class);
 						 e.putExtra(android.content.Intent.EXTRA_TEXT,"http://www.youtube.com/watch?v=wWIuZQaRopI&list=PL9AB7E1F4DEBCA00A&index=14&feature=player_embedded");
